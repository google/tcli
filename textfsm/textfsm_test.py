...
# Needed so the __package__ assignment works.
import tcli   # pylint: disable=unused-import

# Remove local path so that local packages are not imported by default
# This setting is shared by the imported textfsm module.
